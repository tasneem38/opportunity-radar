...
class Database:
    ...
    def insert_agent_output(self, stock_id: str, agent_name: str, signal_type: str, signal_detail: str, confidence: float, raw_event_id: str = None) -> dict:
    ...
    def insert_signal(self, data: dict) -> dict:
        ...
        stock = self.upsert_stock(symbol, company)
    ...
    def get_watchlist(self, user_id: str = None) -> list:
